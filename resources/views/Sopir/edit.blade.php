        ...
        <div class="col-lg-5 col-md-6 col-sm-11">
            <form action="{{ route('sopir.update', $sopir->kd_sopir) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('no_ktp') is-invalid @enderror" id="no_ktp" name="no_ktp" value="{{ old('no_ktp', $sopir->no_ktp) }}" required>
                    @error('no_ktp')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nm_sopir') is-invalid @enderror" id="nm_sopir" name="nm_sopir" value="{{ old('nm_sopir', $sopir->nm_sopir) }}" required>
                    @error('nm_sopir')
                        <div class="text-danger mt-2 mx-1">
                            {{ $message }}
                        </div>
