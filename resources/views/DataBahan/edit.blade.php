            ...
            <div class="col-lg-5 col-md-6 col-sm-11">
                <form action="{{ route('dataBahan.update', $dataBahan->kd_bahan) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nm_bahan" name="nm_bahan" value="{{ $dataBahan->nm_bahan }}" required>
                        @error('nm_bahan')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="harga_beli" name="harga_beli" value="{{ $dataBahan->harga_beli }}" required>
                        @error('harga_beli')
                            <div class="text-danger mt-2 mx-1">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="stok" name="stok" value="{{ $dataBahan->stok }}" required>
                        @error('stok')
                            <div class="text-danger mt-2 mx-1">
                                    {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="ket" name="ket" required>{{ $dataBahan->ket }}</textarea>
                        @error('ket')
                            <div class="text-danger mt-2 mx-1">
                                    {{ $message }}
                            </div>
