    ...
    <div class="col-lg-6 col-md-6 col-sm-11">
      <form action="{{ route('bahanMasuk.store') }}" method="POST">
        ...
        <div class="form-group">
          ...
          <select name="kd_bahan" class="form-select form-control @error('kd_bahan') is-invalid @enderror" required autofocus onchange="changeValue(this.value)">
        ...
        <div class="form-group">
          ...
          <input type="date" class="form-control @error('tgl_masuk') is-invalid @enderror" name="tgl_masuk" id="tgl_masuk" value="{{ old('tgl_masuk') }}" required>
          @error('tgl_masuk')
